// Ícones de marca que o lucide v1 não traz mais (WhatsApp, Instagram, Google).
...
export function GoogleIcon({ className = "size-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      ...
      <path
        fill="#FBBC05"
        d="M5.27 14.29a7.16 7.16 0 0 1 0-4.58V6.62H1.29a11.97 11.97 0 0 0 0 10.76l3.98-3.09Z"
      />
      <path
        fill="#EA4335"
